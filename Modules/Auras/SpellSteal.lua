    ...
    frame.UpdateBuffs = function(self, unit, unitAuraUpdateInfo)
        ...
        self.auras:Iterate(function(auraInstanceID, aura)
            ...
            if not buff then
                ...
                cooldown:SetCountdownFont('StripesAurasSpellStealCooldownFont');
                ...
                if MASQUE_SUPPORT and Stripes.Masque then
                    ...
                    Stripes.MasqueAurasSpellstealGroup:AddButton(buff, { Icon = buff.Icon, Cooldown = cooldown }, 'Aura', true);
                end
