...
panel.Load = function(self)
    ...
    self.combat_indicator_point = E.CreateDropdown('plain', self);
    ...
    self.combat_indicator_point:AddToSearch(button, L['OPTIONS_COMBAT_INDICATOR_POINT_TOOLTIP']);
    self.combat_indicator_point.OnValueChangedCallback = function(_, value)
        O.db.combat_indicator_point = tonumber(value);
        Handler:UpdateAll();
    end

    self.combat_indicator_relative_point = E.CreateDropdown('plain', self);
    ...
    self.combat_indicator_relative_point:AddToSearch(button, L['OPTIONS_COMBAT_INDICATOR_RELATIVE_POINT_TOOLTIP']);
    ...
    SpellInterruptedHeader:SetPosition('TOPLEFT', self.combat_indicator_point, 'BOTTOMLEFT', 0, -8);
