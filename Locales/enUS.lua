...
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_ENABLED'] = 'Special focus texture';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_ENABLED_TOOLTIP'] = 'Enable a special health bar color for the current focus';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_VALUE_TOOLTIP'] = 'Special health bar texture for the current focus';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY'] = 'Overlay';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_TOOLTIP'] = 'Overlay a special texture on top of the current one, not replace it (for the current focus)';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_ALPHA'] = 'Alpha';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_ALPHA_TOOLTIP'] = 'Alpha of the applied special texture for the current focus';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_ALPHA_MODE_TOOLTIP'] = 'Special texture blending mode for the current focus';
