...
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_OVERLAY_ALPHA_TOOLTIP'] = 'Alpha of the applied special texture for the current target';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_OVERLAY_ALPHA_MODE_TOOLTIP'] = 'Special texture blending mode for the current target';
...
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_ALPHA_TOOLTIP'] = 'Alpha of the applied special texture for the current focus target';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_ALPHA_MODE_TOOLTIP'] = 'Special texture blending mode for the current focus target';
