...
L['AURAS_XLIST_MODE_NONE'] = 'Don\'t use';
...
L['OPTIONS_PROFILES_NEW_PROFILE'] = 'New profile';
...
L['OPTIONS_PROFILES_CANT_CHANGE_IN_COMBAT'] = 'Can\'t change profile during combat';
...
L['OPTIONS_NAME_NPC_NAMES'] = 'NPC Names';
L['OPTIONS_NAME_NPC_NAMES_TOOLTIP'] = 'NPC Names Display Mode';
...
L['OPTIONS_FRIEND_ICON_ENABLED'] = 'Friend icon';
L['OPTIONS_FRIEND_ICON_ENABLED_TOOLTIP'] = 'Show the friend icon above the name';
L['OPTIONS_TARGET_NAME_HEADER'] = 'Target name';
...
L['OPTIONS_TARGET_NAME_CUT_ENABLED'] = 'Cut to';
L['OPTIONS_TARGET_NAME_CUT_ENABLED_TOOLTIP'] = 'Forced cutting the target name to a specified number of characters';
L['OPTIONS_TARGET_NAME_CUT_NUMBER_TOOLTIP'] = 'Number of characters of the target name to keep';
...
L['OPTIONS_HEALTH_BAR_BACKGROUND_TEXTURE_VALUE_TOOLTIP'] = 'Health bar background texture';
L['OPTIONS_HEALTH_BAR_BACKGROUND_COLOR_TOOLTIP'] = 'Background color of the health bar';
...
L['OPTIONS_HEALTH_BAR_BORDER_SAME_COLOR'] = 'Same color';
...
L['OPTIONS_HEADER_SPARK'] = 'Spark';
L['OPTIONS_HEALTH_BAR_SPARK_SHOW_TOOLTIP'] = 'Show a spark at the end of the health bar';
L['OPTIONS_HEALTH_BAR_SPARK_HIDE_AT_MAX_HEALTH'] = 'Hide at max';
L['OPTIONS_HEALTH_BAR_SPARK_HIDE_AT_MAX_HEALTH_TOOLTIP'] = 'Hide the spark at the maximum health value';
L['OPTIONS_HEALTH_BAR_SPARK_WIDTH_TOOLTIP'] = 'Width of the health bar spark';
L['OPTIONS_HEALTH_BAR_SPARK_HEIGHT_TOOLTIP'] = 'Height of the health bar spark';
...
L['OPTIONS_HEALTH_BAR_COLOR_ENEMY_PET'] = 'Enemy pets';
L['OPTIONS_HEALTH_BAR_COLOR_ENEMY_PET_TOOLTIP'] = 'Color for enemy pets';
...
L['OPTIONS_HEALTH_BAR_COLOR_FRIENDLY_PET'] = 'Friendly pets';
L['OPTIONS_HEALTH_BAR_COLOR_FRIENDLY_PET_TOOLTIP'] = 'Color for friendly pets';
...
L['OPTIONS_HEALTH_BAR_COLOR_DEAD'] = 'Dead';
L['OPTIONS_HEALTH_BAR_COLOR_DEAD_TOOLTIP'] = 'Color for dead units';
L['OPTIONS_HEALTH_BAR_COLORS_RESET_TOOLTIP'] = 'Reset health bar colors to defaults';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_HEADER'] = 'Classes';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_USE'] = 'Use';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_USE_TOOLTIP'] = 'Use your colors for classes';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_DEATHKNIGHT'] = 'Death Knight';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_DEATHKNIGHT_TOOLTIP'] = 'Death Knight color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_DEMONHUNTER'] = 'Demon Hunter';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_DEMONHUNTER_TOOLTIP'] = 'Demon Hunter color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_DRUID'] = 'Druid';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_DRUID_TOOLTIP'] = 'Druid color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_HUNTER'] = 'Hunter';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_HUNTER_TOOLTIP'] = 'Hunter color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_MAGE'] = 'Mage';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_MAGE_TOOLTIP'] = 'Mage color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_MONK'] = 'Monk';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_MONK_TOOLTIP'] = 'Monk color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_PALADIN'] = 'Paladin';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_PALADIN_TOOLTIP'] = 'Paladin color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_PRIEST'] = 'Priest';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_PRIEST_TOOLTIP'] = 'Priest color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_ROGUE'] = 'Rogue';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_ROGUE_TOOLTIP'] = 'Rogue color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_SHAMAN'] = 'Shaman';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_SHAMAN_TOOLTIP'] = 'Shaman color';
L['OPTIONS_HEALTH_BAR_COLORS_CLASS_WARLOCK'] = 'Warlock';
...
L['OPTIONS_THREAT_COLOR_NAME'] = 'Color the name';
L['OPTIONS_THREAT_COLOR_NAME_TOOLTIP'] = 'Use threat colors for the name';
L['OPTIONS_THREAT_COLOR_NAME_ONLY'] = 'Only name';
L['OPTIONS_THREAT_COLOR_NAME_ONLY_TOOLTIP'] = 'Use threat colors to color only the name';
L['OPTIONS_THREAT_COLOR_PRIO_HIGH'] = 'High threat color priority';
L['OPTIONS_THREAT_COLOR_PRIO_HIGH_TOOLTIP'] = 'Enable priority for high threat color over other colors (e.g. coloring by aura, custom health color, etc.)';
L['OPTIONS_THREAT_COLOR_PRIO_HIGH_EXCLUDE_TANK_ROLE'] = 'Exclude tank role';
L['OPTIONS_THREAT_COLOR_PRIO_HIGH_EXCLUDE_TANK_ROLE_TOOLTIP'] = 'Exclude tank role for high threat priority (if you\'re a tank)';
...
L['OPTIONS_TARGET_INDICATOR_COLOR_AS_CLASS'] = 'By class color';
L['OPTIONS_TARGET_INDICATOR_COLOR_AS_CLASS_TOOLTIP'] = 'Color the target indicator according to the color of your class';
L['OPTIONS_TARGET_INDICATOR_TEXTURE'] = 'Texture';
L['OPTIONS_TARGET_INDICATOR_TEXTURE_TOOLTIP'] = 'Target indicator texture|n|nIf the texture is colored, then paint it white and everything will be fine';
...
L['OPTIONS_CURRENT_TARGET_HEALTH_BAR_COLORING_TOOLTIP'] = 'Enable a special health bar color for the current target';
L['OPTIONS_CURRENT_TARGET_HEALTH_BAR_COLOR_TOOLTIP'] = 'Special health bar color for the current target';
L['OPTIONS_CURRENT_TARGET_HEALTH_BAR_USE_CLASS_COLOR'] = 'By class color';
L['OPTIONS_CURRENT_TARGET_HEALTH_BAR_USE_CLASS_COLOR_TOOLTIP'] = 'Color the health bar according to the color of your class for the current target';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_ENABLED'] = 'Special target texture';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_ENABLED_TOOLTIP'] = 'Enable a special health bar texture for the current target';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_VALUE_TOOLTIP'] = 'Special health bar texture for the current target';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_OVERLAY'] = 'Overlay';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_OVERLAY_TOOLTIP'] = 'Overlay a special texture on top of the current one, not replace it (for the current target)';
L['OPTIONS_CURRENT_TARGET_CUSTOM_TEXTURE_OVERLAY_COLOR_TOOLTIP'] = 'Сolor of the special texture for the current target';
L['OPTIONS_CURRENT_FOCUS_HEALTH_BAR_COLORING'] = 'Special focus target color';
L['OPTIONS_CURRENT_FOCUS_HEALTH_BAR_COLORING_TOOLTIP'] = 'Enable a special health bar color for the current focus target';
L['OPTIONS_CURRENT_FOCUS_HEALTH_BAR_COLOR_TOOLTIP'] = 'Special health bar color for the current focus target';
L['OPTIONS_CURRENT_FOCUS_HEALTH_BAR_USE_CLASS_COLOR'] = 'By class color';
L['OPTIONS_CURRENT_FOCUS_HEALTH_BAR_USE_CLASS_COLOR_TOOLTIP'] = 'Color the health bar according to the color of your class for the current focus target';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_ENABLED'] = 'Special focus target texture';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_ENABLED_TOOLTIP'] = 'Enable a special health bar color for the current focus target';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_VALUE_TOOLTIP'] = 'Special health bar texture for the current focus target';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY'] = 'Overlay';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_TOOLTIP'] = 'Overlay a special texture on top of the current one, not replace it (for the current focus target)';
L['OPTIONS_CURRENT_FOCUS_CUSTOM_TEXTURE_OVERLAY_COLOR_TOOLTIP'] = 'Color of the special texture for the current focus target';
...
L['OPTIONS_CAST_BAR_TAB_COLORS'] = 'Colors';
...
L['OPTIONS_CAST_BAR_BACKGROUND_TEXTURE_VALUE_TOOLTIP'] = 'Cast bar background texture';
L['OPTIONS_CAST_BAR_BACKGROUND_COLOR_TOOLTIP'] = 'Background color of the cast bar';
L['OPTIONS_CAST_BAR_HEADER_CAST_NAME'] = 'Cast name';
L['OPTIONS_CAST_BAR_TEXT_ANCHOR_TOOLTIP'] = 'Cast name position';
L['OPTIONS_CAST_BAR_TEXT_OFFSET_X_TOOLTIP'] = 'Horizontal offset of cast name';
L['OPTIONS_CAST_BAR_TEXT_OFFSET_Y_TOOLTIP'] = 'Vertical offset of cast name';
L['OPTIONS_CAST_BAR_TEXT_TRUNCATE'] = 'Truncate';
L['OPTIONS_CAST_BAR_TEXT_TRUNCATE_TOOLTIP'] = 'Truncate the name if it goes outside the cast bar';
L['OPTIONS_CAST_BAR_TEXT_FONT_VALUE'] = 'Cast name font';
L['OPTIONS_CAST_BAR_TEXT_FONT_SIZE'] = 'Cast name font size';
L['OPTIONS_CAST_BAR_TEXT_FONT_FLAG'] = 'Cast name font outline';
L['OPTIONS_CAST_BAR_TEXT_FONT_SHADOW'] = 'Cast name font shadow';
L['OPTIONS_CAST_BAR_TARGET_HEADER'] = 'Cast target name';
L['OPTIONS_CAST_BAR_TARGET_ENABLED'] = 'Enable';
L['OPTIONS_CAST_BAR_TARGET_ENABLED_TOOLTIP'] = 'Show the target name of the current cast';
L['OPTIONS_CAST_BAR_TARGET_CLASS_COLOR'] = 'Class color';
L['OPTIONS_CAST_BAR_TARGET_CLASS_COLOR_TOOLTIP'] = 'Color the target name of the current cast with the class color';
L['OPTIONS_CAST_BAR_TARGET_ONLY_ENEMY'] = 'Only for enemies';
L['OPTIONS_CAST_BAR_TARGET_ONLY_ENEMY_TOOLTIP'] = 'Show the target name of the current cast only for enemy nameplates';
L['OPTIONS_CAST_BAR_TARGET_IN_SPELL_NAME'] = 'In cast name';
L['OPTIONS_CAST_BAR_TARGET_IN_SPELL_NAME_TOOLTIP'] = 'Show the target name of the current cast along with the name of the cast|n|n|cffff6666Note: selected font and position settings will have no effect|r';
L['OPTIONS_CAST_BAR_TEXT_POINT_TOOLTIP'] = 'Point of attachment of cast target name text';
L['OPTIONS_CAST_BAR_TEXT_RELATIVE_POINT_TOOLTIP'] = 'To which point of the cast bar attach cast target name text';
L['OPTIONS_CAST_BAR_TEXT_OFFSET_X_TOOLTIP'] = 'Horizontal offset of cast target name text';
L['OPTIONS_CAST_BAR_TEXT_OFFSET_Y_TOOLTIP'] = 'Vertical offset of cast target name text';
L['OPTIONS_CAST_BAR_TARGET_FONT_VALUE'] = 'Cast target name font';
L['OPTIONS_CAST_BAR_TARGET_FONT_SIZE'] = 'Cast target name font size';
L['OPTIONS_CAST_BAR_TARGET_FONT_FLAG'] = 'Cast target name font outline';
L['OPTIONS_CAST_BAR_TARGET_FONT_SHADOW'] = 'Cast target name font shadow';
...
L['OPTIONS_CAST_BAR_CUSTOM_CASTS_ON_YOU'] = 'On you';
...
L['OPTIONS_VISIBILITY_SHOW_ALWAYS_PVP_INSTANCE'] = 'Always in PvP instances';
L['OPTIONS_VISIBILITY_SHOW_ALWAYS_PVP_INSTANCE_TOOLTIP'] = 'Enable permanent display of nameplates in PvP instances';
L['OPTIONS_VISIBILITY_MAX_DISTANCE_OPENWORLD'] = 'Open world';
L['OPTIONS_VISIBILITY_MAX_DISTANCE_OPENWORLD_TOOLTIP'] = 'Nameplates distance in open world|n|n|cffffb833Locked by «Blizzard»|r';
L['OPTIONS_VISIBILITY_MAX_DISTANCE_INSTANCE'] = 'Dungeons / Raids';
L['OPTIONS_VISIBILITY_MAX_DISTANCE_INSTANCE_TOOLTIP'] = 'Nameplates distance in dungeons / raids|n|n|cffffb833Locked by «Blizzard»|r';
L['OPTIONS_VISIBILITY_MAX_DISTANCE_PVP_INSTANCE'] = 'PvP instances';
L['OPTIONS_VISIBILITY_MAX_DISTANCE_PVP_INSTANCE_TOOLTIP'] = 'Nameplates distance in PvP instances|n|n|cffffb833Locked by «Blizzard»|r';
...
L['OPTIONS_VISIBILITY_NAME_ONLY_ENABLED_TOOLTIP'] = 'Enable «Name Only» mode for friendly nameplates|n|nIn this mode, the health bars and spells of friendly nameplates are hidden';
...
L['OPTIONS_VISIBILITY_NAME_ONLY_SHOW_LEVEL'] = 'Level';
L['OPTIONS_VISIBILITY_NAME_ONLY_SHOW_LEVEL_TOOLTIP'] = 'Show level in the «Name Only» mode|n|n|cffff6666Only in open world|r';
...
L['OPTIONS_VISIBILITY_NAME_ONLY_SHOW_BACKGROUND'] = 'Background';
L['OPTIONS_VISIBILITY_NAME_ONLY_SHOW_BACKGROUND_TOOLTIP'] = 'Show background in the «Name Only» mode';
L['OPTIONS_VISIBILITY_NAME_ONLY_BACKGROUND_COLOR_TOOLTIP'] = 'Background color in the «Name Only» mode';
...
L['OPTIONS_CLASS_BAR_ALPHA_TOOLTIP'] = 'Alpha of the class bar';
...
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_FONT_VALUE'] = 'Mythic+ percentage font value';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_FONT_SIZE'] = 'Mythic+ percentage font size';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_FONT_FLAG'] = 'Mythic+ percentage font outline';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_FONT_SHADOW'] = 'Mythic+ percentage font shadow';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_POINT_TOOLTIP'] = 'Point of attachment of mythic+ percentage';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_RELATIVE_POINT_TOOLTIP'] = 'To which point of the health bar attach the mythic+ percentage';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_OFFSET_X_TOOLTIP'] = 'Horizontal offset of mythic+ percentage';
L['OPTIONS_MYTHIC_PLUS_PERCENTAGE_OFFSET_Y_TOOLTIP'] = 'Vertical offset of mythic+ percentage';
...
L['OPTIONS_EXPLOSIVE_ORBS_COUNTER_FONT_VALUE_TOOLTIP'] = 'Font of the quantity of active explosive orbs';
L['OPTIONS_EXPLOSIVE_ORBS_COUNTER_FONT_SIZE_TOOLTIP'] = 'Font size of the quantity of active explosive orbs';
L['OPTIONS_EXPLOSIVE_ORBS_COUNTER_FONT_FLAG_TOOLTIP'] = 'Font outline of the quantity of active explosive orbs';
L['OPTIONS_EXPLOSIVE_ORBS_COUNTER_FONT_SHADOW_TOOLTIP'] = 'Font shadow of the quantity of active explosive orbs';
...
L['OPTIONS_SPITEFUL_TTD_ENABLED'] = 'Time to die';
L['OPTIONS_SPITEFUL_TTD_ENABLED_TOOLTIP'] = 'Show time to death for «The Spiteful Shade»';
...
L['OPTIONS_QUEST_INDICATOR_FONT_VALUE_TOOLTIP'] = 'Font of the quest indicator';
L['OPTIONS_QUEST_INDICATOR_FONT_SIZE_TOOLTIP'] = 'Font size of the quest indicator';
L['OPTIONS_QUEST_INDICATOR_FONT_FLAG_TOOLTIP'] = 'Font outline of the quest indicator';
L['OPTIONS_QUEST_INDICATOR_FONT_SHADOW_TOOLTIP'] = 'Font shadow of the quest indicator';
...
L['OPTIONS_STEALTH_DETECT_GLOW_TOOLTIP'] = 'Glow type of the stealth detection icon';
L['OPTIONS_STEALTH_DETECT_GLOW_COLOR_TOOLTIP'] = 'Glow color of the stealth detection icon';
...
L['OPTIONS_SPELL_INTERRUPTED_ICON_COUNTDOWN_FONT_SIZE'] = 'Countdown font size of spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_COUNTDOWN_FONT_FLAG'] = 'Countdown font outline of spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_COUNTDOWN_FONT_SHADOW'] = 'Countdown font shadow of spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_CASTER_NAME_TEXT'] = 'Player name';
...
L['OPTIONS_SPELL_INTERRUPTED_ICON_CASTER_NAME_FONT_VALUE'] = 'Player name font on spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_CASTER_NAME_FONT_SIZE'] = 'Player name font size on spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_CASTER_NAME_FONT_FLAG'] = 'Player name font outline on spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_CASTER_NAME_FONT_SHADOW'] = 'Player name font shadow on spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_SHOW_INTERRUPTED_ICON'] = 'Show the icon of the interrupted spell';
L['OPTIONS_SPELL_INTERRUPTED_ICON_SHOW_INTERRUPTED_ICON_TOOLTIP'] = 'Show the icon of the interrupted spell instead of the one interrupted it';
L['OPTIONS_SPELL_INTERRUPTED_ICON_COOLDOWN_DRAW_SWIPE'] = 'Swipe';
L['OPTIONS_SPELL_INTERRUPTED_ICON_COOLDOWN_DRAW_SWIPE_TOOLTIP'] = 'Show swipe effect on the spell interrupted icon';
L['OPTIONS_SPELL_INTERRUPTED_ICON_COOLDOWN_DRAW_EDGE'] = 'Edge';
L['OPTIONS_SPELL_INTERRUPTED_ICON_COOLDOWN_DRAW_EDGE_TOOLTIP'] = 'Show edge effect on the spell interrupted icon';
L['OPTIONS_PVP_HEALERS_HEADER'] = 'PvP';
L['OPTIONS_PVP_HEALERS_ENABLED'] = 'Enable';
...
L['OPTIONS_PVP_HEALERS_POINT_TOOLTIP'] = 'Point of attachment of mark of enemy healers in PvP';
L['OPTIONS_PVP_HEALERS_RELATIVE_POINT_TOOLTIP'] = 'To which point of the health bar attach mark of enemy healers in PvP';
L['OPTIONS_PVP_HEALERS_OFFSET_X_TOOLTIP'] = 'Horizontal offset of the mark on enemy healers in PvP';
L['OPTIONS_PVP_HEALERS_OFFSET_Y_TOOLTIP'] = 'Vertical offset of the mark on enemy healers in PvP';
L['OPTIONS_PVP_HEALERS_ICON_STRATA_TOOLTIP'] = 'Strata for the mark of enemy healers in PvP';
...
L['OPTIONS_PVE_HEALERS_ENABLED'] = 'Enable';
...
L['OPTIONS_PVE_HEALERS_POINT_TOOLTIP'] = 'Point of attachment of mark of enemy healers in PvE';
L['OPTIONS_PVE_HEALERS_RELATIVE_POINT_TOOLTIP'] = 'To which point of the health bar attach mark of enemy healers in PvE';
L['OPTIONS_PVE_HEALERS_OFFSET_X_TOOLTIP'] = 'Horizontal offset of the mark on enemy healers in PvE';
L['OPTIONS_PVE_HEALERS_OFFSET_Y_TOOLTIP'] = 'Vertical offset of the mark on enemy healers in PvE';
L['OPTIONS_PVE_HEALERS_ICON_STRATA_TOOLTIP'] = 'Strata for the mark of enemy healers in PvE';
...
L['OPTIONS_AURAS_SHOW_DEBUFFS_ON_FRIENDLY'] = 'Debuffs on friendly';
L['OPTIONS_AURAS_SHOW_DEBUFFS_ON_FRIENDLY_TOOLTIP'] = 'Show debuffs on friendly nameplates';
L['OPTIONS_AURAS_SORT_ENABLED'] = 'Sort';
...
L['OPTIONS_AURAS_COOLDOWN_COLOR_TOOLTIP'] = 'Countdown text color';
...
L['OPTIONS_AURAS_COUNT_COLOR_TOOLTIP'] = 'Count text color';
...
L['OPTIONS_AURAS_HPBAR_COLOR_ENABLED_TOOLTIP'] = 'Turn on the coloring of the health bar depending on the presence of a given aura|n|n|cffff6666Affects performance|r';
L['OPTIONS_AURAS_HPBAR_COLOR_LIST_BUTTON_OPEN'] = 'Open list';
L['OPTIONS_AURAS_HPBAR_COLOR_LIST_BUTTON_CLOSE'] = 'Close list';
L['OPTIONS_AURAS_MASQUE_SUPPORT'] = '«Masque» support';
...
L['OPTIONS_AURAS_SPELLSTEAL_STATIC_POSITION_TOOLTIP'] = 'Enable static position of dispellable auras';
...
L['OPTIONS_AURAS_SPELLSTEAL_COOLDOWN_COLOR_TOOLTIP'] = 'Countdown text color of dispellable auras';
...
L['OPTIONS_AURAS_MYTHICPLUS_COOLDOWN_COLOR_TOOLTIP'] = 'Countdown text color of mythic+ auras';
...
L['OPTIONS_AURAS_IMPORTANT_SPACING_X_TOOLTIP'] = 'Horizontal spacing between important auras';
L['OPTIONS_AURAS_IMPORTANT_OFFSET_X_TOOLTIP'] = 'Horizontal offset of important auras';
...
L['OPTIONS_AURAS_IMPORTANT_COOLDOWN_COLOR_TOOLTIP'] = 'Countdown text color of important auras';
...
L['OPTIONS_AURAS_IMPORTANT_COUNT_COLOR_TOOLTIP'] = 'Count text color of important auras';
L['OPTIONS_AURAS_IMPORTANT_CASTERNAME_TEXT'] = 'Player name';
...
L['OPTIONS_AURAS_CUSTOM_COOLDOWN_COLOR_TOOLTIP'] = 'Countdown text color of custom auras';
...
L['OPTIONS_AURAS_CUSTOM_COUNT_COLOR_TOOLTIP'] = 'Count text color of custom auras';
