...
-- Fonts
LSM:Register(LSM.MediaType.FONT, 'BigNoodleToo Oblique', S.Media.Fonts.BIGNOODLETOO.OBLIQUE, 2);
LSM:Register(LSM.MediaType.FONT, 'BigNoodleToo Titling', S.Media.Fonts.BIGNOODLETOO.TITLING, 2);
LSM:Register(LSM.MediaType.FONT, 'Brutal Type', S.Media.Fonts.BRUTALTYPE.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Brutal Type Light', S.Media.Fonts.BRUTALTYPE.LIGHT, 2);
LSM:Register(LSM.MediaType.FONT, 'Brutal Type Medium', S.Media.Fonts.BRUTALTYPE.MEDIUM, 2);
LSM:Register(LSM.MediaType.FONT, 'Brutal Type Bold', S.Media.Fonts.BRUTALTYPE.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Convection Regular', S.Media.Fonts.CONVECTION.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Convection Medium', S.Media.Fonts.CONVECTION.MEDIUM, 2);
LSM:Register(LSM.MediaType.FONT, 'Convection Bold', S.Media.Fonts.CONVECTION.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Expressway Regular', S.Media.Fonts.EXPRESSWAY.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Expressway Bold', S.Media.Fonts.EXPRESSWAY.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Book', S.Media.Fonts.FUTURAPT.BOOK, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Book Oblique', S.Media.Fonts.FUTURAPT.BOOKOBLIQUE, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Medium', S.Media.Fonts.FUTURAPT.MEDIUM, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Medium Oblique', S.Media.Fonts.FUTURAPT.MEDIUMOBLIQUE, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Demi', S.Media.Fonts.FUTURAPT.DEMI, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Demi Oblique', S.Media.Fonts.FUTURAPT.DEMIOBLIQUE, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Bold', S.Media.Fonts.FUTURAPT.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Futura PT Bold Oblique', S.Media.Fonts.FUTURAPT.BOLDOBLIQUE, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Regular', S.Media.Fonts.GOTHAMPRO.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Italic', S.Media.Fonts.GOTHAMPRO.ITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Black', S.Media.Fonts.GOTHAMPRO.BLACK, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Black Italic', S.Media.Fonts.GOTHAMPRO.BLACKITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Bold', S.Media.Fonts.GOTHAMPRO.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Bold Italic', S.Media.Fonts.GOTHAMPRO.BOLDITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Light', S.Media.Fonts.GOTHAMPRO.LIGHT, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Light Italic', S.Media.Fonts.GOTHAMPRO.LIGHTITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Medium', S.Media.Fonts.GOTHAMPRO.MEDIUM, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Medium Italic', S.Media.Fonts.GOTHAMPRO.MEDIUMITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Narrow', S.Media.Fonts.GOTHAMPRO.NARROW, 2);
LSM:Register(LSM.MediaType.FONT, 'Gotham Pro Narrow Bold', S.Media.Fonts.GOTHAMPRO.NARROWBOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Regular', S.Media.Fonts.OSWALD.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Regular Italic', S.Media.Fonts.OSWALD.REGULARITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Medium', S.Media.Fonts.OSWALD.MEDIUM, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Medium Italic', S.Media.Fonts.OSWALD.MEDIUMITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Demi', S.Media.Fonts.OSWALD.DEMI, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Demi Italic', S.Media.Fonts.OSWALD.DEMIITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Bold', S.Media.Fonts.OSWALD.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Oswald Bold Italic', S.Media.Fonts.OSWALD.BOLDITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'PT Sans Narrow Bold', S.Media.Fonts.PTSANS.NARROWBOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'PT Sans Bold', S.Media.Fonts.PTSANS.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Roboto', S.Media.Fonts.ROBOTO.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Roboto Italic', S.Media.Fonts.ROBOTO.ITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Roboto Medium', S.Media.Fonts.ROBOTO.MEDIUM, 2);
LSM:Register(LSM.MediaType.FONT, 'Roboto Medium Italic', S.Media.Fonts.ROBOTO.MEDIUMITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Roboto Bold', S.Media.Fonts.ROBOTO.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Roboto Bold Italic', S.Media.Fonts.ROBOTO.BOLDITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'RPL Regular', S.Media.Fonts.RPL.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Systopie', S.Media.Fonts.SYSTOPIE.REGULAR, 2);
LSM:Register(LSM.MediaType.FONT, 'Systopie Italic', S.Media.Fonts.SYSTOPIE.REGULARITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Systopie Semi Bold', S.Media.Fonts.SYSTOPIE.SEMIBOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Systopie Semi Bold Italic', S.Media.Fonts.SYSTOPIE.SEMIBOLDITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Systopie Bold', S.Media.Fonts.SYSTOPIE.BOLD, 2);
LSM:Register(LSM.MediaType.FONT, 'Systopie Bold Italic', S.Media.Fonts.SYSTOPIE.BOLDITALIC, 2);
LSM:Register(LSM.MediaType.FONT, 'Teen CYR', S.Media.Fonts.TEEN.CYR, 2);
